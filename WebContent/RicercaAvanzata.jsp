...
<body class="is-preload">
	...
	<!-- Header -->
	<header id="header">
		<a class="logo" href="index.html">Pongo</a>
		<nav>
			<a href="#menu">Menu</a>
		</nav>
	</header>
	...
	<section id="banner" >
		<div class="inner" >
			...
			<p>
				Con la nostra ricerca avanzata potrai trovare ciò che più soddisfa le tue esigenze.<br>
				Ricerca l'auto dei tuoi sogni!<br>
			</p>
		</div>
			...
			<div class="inner">
				...
				<td><div class="col-12">
									<select name="category" id="category">
										...
										<option value="alpha">Audi</option>
